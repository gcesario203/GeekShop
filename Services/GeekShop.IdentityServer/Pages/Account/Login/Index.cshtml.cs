...
namespace GeekShop.IdentityServer.Pages.Login;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        {
            var result = await _sigInManager.PasswordSignInAsync(Input.Username, Input.Password, Input.RememberLogin, lockoutOnFailure: false);
